        ...
        <div class="container flex flex-col gap-5">
            <header class="flex items-center justify-between">
                <div class="container flex items-center flex-wrap justify-center sm:justify-between gap-3">
                    <h1 class="font-sans font-bold text-3xl">Days</h1>
...
<form class="max-w-md mx-auto">   
    ...
    <div class="relative">
        ...
        <input v-model="searchValue" type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search dictionary" required />
                        ...
                        <button @click="router.push('/a2/mainwords/test')" type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Start Test</button>
                    </span>
                </div>
            </header>
...
import en_uz from "../../../json/A2/en_uz.json";
import { ref,reactive,computed } from 'vue';
const data=ref(en_uz[0].MainWords.description.allMainWords);
